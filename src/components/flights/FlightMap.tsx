...
function RankingTitle({title}:{title:string}){const lines=[title.split(' ')[0],title.split(' ').slice(1).join(' ')];return <h3 className="ranking-title"><span>{lines[0]}</span><span>{lines[1]}</span></h3>}
